...
//									from command line 
// startPointString		string 		Keeps information about 
//									which process started
//									detection
// startPointInteger	string 		Keeps information about 
//									which process started
//									detection
// parent				int			Row number in int 
//									**adjacencyMatrix 
//									represents parent of child node
// child				int			Column number in int 
//									**adjacencyMatrix 
//									represents child node
// flag		  		 	int			Keeps information about whether
//									there is a deadlock or not.
// counter				int 		Counter fot column
// **adjacencyMatrix	int[][]		That represents dependency 
//									graph
//probe[]				int 		It keeps probe info that
//									contains ID of process
//									that blocked, ID of process
//									sending message, ID of process
//									that receiving message.
// eventLineCString		char[]		C string version of 
//									eventLineString
//*******************************************************************
...
// starter				int 		Keeps information about 
//									which process started
//									detection
//probe[]				int 		It keeps probe info that
//									contains ID of process

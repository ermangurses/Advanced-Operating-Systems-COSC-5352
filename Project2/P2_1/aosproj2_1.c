...
// properfunctions for the propers processes then it finalize MPI 
// environment. 
//
// Return Value
// ------------
...
// respectively. 
// 
// Then the token that turns clock wise order is increased by 1 and 
// the token that turns counter clock wise order is decrased by 1. 
// The  token which is increased by one has a value of nprocs times 
// rounds. After all, each tokens is ended up process 0.
//
// Return Value
// ------------
// void                       

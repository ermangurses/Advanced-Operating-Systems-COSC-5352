...
// Reference  Parameters
// --------------------
// *argv[]	  char 	   		    Pointers of Arrays that keeps 
...
// eventLine					string		Entire event line
//											that is read from file
// numberOfProcesses			string		Number of worker processes
// completed					char		Key message to check operations
//											in order
// endString					string		Key string check end of file
// * eventLineCharArrayParsing	char		The char array that is parsed
//											into tokens
// * file						char		keep file name that is entered
//											from command line 
// * eventLineCharArray			char		Keeps entire line
// * eventTypeCharArray			char		Keeps event type
// * eventSourceCharArray		char		Keeps event source info
//*******************************************************************
void manager(MPI_Status status, char * argv[],int nprocs)
{
	ifstream 	inFile;
...
// status	  MPI_status  	    status information	
// nprocs	  int				The number of processes 
// rank 	  int 				keeps process rank information
//
// Reference  Parameters
// --------------------
//	void
...
// Local Variables
// ---------------
// eventDestinationInteger		int			destination of event
// eventSourceInteger			int			source of event
// eventMessageLength		    int 		Message Length
// eventLineLenght				int 		Entire line's lenght
// * clock1						int 		Actual vector clock info
// * clock2						int 		Temporary vector clock info
// sendEvent[]					char		Keeps send event code
...
// * eventTypeCharArray			char		Keeps event type
// * eventSourceCharArray		char		Keeps event source info
// * eventDestinationCharArray	char		Keeps event destination info
// * eventMessageCharArray		char		Keeps actual message
// isMessageExist				boolean		Flag for while loop
//*******************************************************************
void workers(MPI_Status status, int rank, int nprocs)
{	
